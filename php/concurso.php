            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <form action="insertarConcurso.php" method="POST">
                        ...
                        <input type="text" class="form-control mb-3" name="nombre_concurso" placeholder="nombre">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <th><a href="listarConcurso.php?id=<?php echo $row['id_concurso'] ?>" class="btn btn-info">Consultar</a></th>
